...
const HomeVoiceCloneTab = () => {
  ...
  return (
    <div className="animate-fade-in space-y-6">
      {/* Voice Sample Cards */}
      <div className="bg-white border border-border/50 rounded-[3px] p-6 flex flex-col">
        ...
        <p className="text-left text-sm text-muted-foreground mt-6 pt-4 border-t border-border/50">
