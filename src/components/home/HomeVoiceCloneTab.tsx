...
const HomeVoiceCloneTab = () => {
  ...
  return (
    <div className="animate-fade-in">
      {/* Single White Card containing both voice samples */}
      <div className="rounded-[3px] bg-white px-8 py-6">
        <div className="flex items-start justify-center gap-12">
          {voiceSamples.map((sample, index) => (
            <div key={sample.id} className="flex items-center gap-6">
        ...
        <p className="text-left text-sm text-muted-foreground mt-6 pt-4 border-t border-border/30">
