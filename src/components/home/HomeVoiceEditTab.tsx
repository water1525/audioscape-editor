...
const handleConfirm = async () => {
  ...
  return (
    <div className="animate-fade-in space-y-4">
      ...
      {/* Original audio card */}
      <div className="bg-white border border-border/30 rounded-[3px] flex flex-col overflow-hidden">
        ...
        <p className="text-sm text-muted-foreground px-4 py-3 border-t border-border/50">
