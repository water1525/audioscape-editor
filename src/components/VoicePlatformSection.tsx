  ...
  return (
    <section className="bg-[#1246D9] py-20 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white border border-border/50 rounded-[3px] shadow-xl">
          {/* Top Tabs */}
        ...
        <div className="flex flex-col items-center justify-center gap-4 mt-8 px-2">
          ...
          <Link to="/playground">
            <Button className="px-6 py-2.5 h-auto text-base font-semibold bg-[#AD0606] hover:bg-[#8a0505] text-white shadow-lg shadow-[#AD0606]/25 hover:shadow-xl hover:shadow-[#AD0606]/30 transition-all duration-300">
              Try Now
            </Button>
          </Link>
        </div>
